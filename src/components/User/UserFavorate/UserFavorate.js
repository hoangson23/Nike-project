...
import * as ActionType from "../../../components/Cart/Module/Contants/contants";
...
const UserFavoriteComponent = () => {
  ...
  const handleNull = () => {
    if (edit === null) {
      return <h1>item add to your Favorite will be saved here</h1>;
              ...
              return (
                <Grid item xs={6} lg={4} key={key}>
                  ...
                  <div className={classes.ProductDetail}>
                    ...
                    <div className={classes.ProductType}>size:{item?.size}</div>
