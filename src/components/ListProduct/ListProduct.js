...
import { Hidden, Grid, AppBar } from '@mui/material'
...
const ListProduct = () => {
    ...
    const data = useSelector(state => state.reducerURL.dataSearchList)
    ...
    const filterSort = useSelector(state => state.reducerURL.filterSort)
